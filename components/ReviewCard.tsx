      ...
      <div className="flex items-start">
        ...
        <div className="ml-2">
          <div className="flex items-center">
            <svg
              className="block h-3 w-3 align-middle text-yellow-500"
            ...
            <svg
              className="block h-3 w-3 align-middle text-gray-400"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
          ...
          <p className="mt-5 text-xs md:text-base text-gray-900">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Porro
            blanditiis sapiente ab dolores.
          </p>
